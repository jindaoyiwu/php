 ...
 * @method static null bitfield($key, $subcommand, ...$subcommandArg)
 * @method static int bitpos($key, $bit, $start = null, $end = null)
 ...
 * @method static null getset($key, $value)
 ...
 * @method static static null hget($key, $field)
 ...
 * @method static null brpoplpush($source, $destination, $timeout)
 * @method static null lindex($key, $index)
 * @method static int linsert($key, $whence, $pivot, $value)
 * @method static int llen($key)
 * @method static null lpop($key)
 * @method static int lpush($key, array $values)
 * @method static int lpushx($key, array $values)
 ...
 * @method static null rpop($key)
 * @method static null rpoplpush($source, $destination)
 * @method static int rpush($key, array $values)
 * @method static int rpushx($key, array $values)
 ...
 * @method static null srandmember($key, $count = null)
 ...
 * @method static null zrank($key, $member)
 ...
 * @method static null zrevrank($key, $member)
 * @method static null zscore($key, $member)
 ...
 * @method static null geodist($key, $member1, $member2, $unit = null)
